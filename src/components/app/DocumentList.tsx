...
function SourceBadge({ type }: { type: Document["source_type"] }) {
  ...
  if (type === "pdf_ocr") {
    return (
      <span className="inline-flex items-center gap-1.5 rounded-md border border-cyan-500/25 bg-cyan-500/10 px-2 py-1 text-[11px] font-medium text-cyan-300">
    ...
    <>
      <div className="space-y-5">
        <section className="app-panel overflow-hidden rounded-lg">
          <div className="border-b border-zinc-800/70 bg-[linear-gradient(135deg,rgba(139,92,246,0.10),transparent_40%)] p-5">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 border-b border-zinc-800/70 px-4 py-3">
            <div className="relative min-w-[240px] flex-1 sm:max-w-sm">
              ...
              <input
                ...
                className="w-full rounded-lg border border-zinc-800 bg-zinc-950/70 py-2 pl-9 pr-4 text-sm text-zinc-100 outline-none transition-colors placeholder:text-zinc-600 focus:border-violet-500/50 focus:ring-1 focus:ring-violet-500/30"
              />
            </div>
